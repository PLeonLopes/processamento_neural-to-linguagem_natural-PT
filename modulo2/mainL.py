...
model.compile(
    optimizer="sgd",                # (Stochastic Gradient Descent) algoritmo de otimização mais simples e amplamente usado. Ele atualiza os pesos do modelo gradualmente com base na derivada do erro em relação a cada peso.
